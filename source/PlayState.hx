...
class PlayState extends MusicBeatState
{
	...
	function opponentNoteHit(note:Note):Void
	{
		...
		if(note.noteType == 'Hey!' && dad.animOffsets.exists('hey')) {
			...
			{
				if(char.animation.curAnim.curFrame ==  char.animation.curAnim.frames.length - 1)
							{
								char.playAnim(animToPlay, true);
				char.holdTimer = 0;
								char.animation.curAnim.curFrame = char.animation.curAnim.frames.length;
							}
							else if(char.animation.curAnim.curFrame ==  char.animation.curAnim.frames.length)
							{
								char.playAnim(animToPlay, true);
				char.holdTimer = 0;
								char.animation.curAnim.curFrame = char.animation.curAnim.frames.length - 3;
							}
				else if (char.animation.curAnim.curFrame == char.animation.curAnim.frames.length-2)
				{
					char.playAnim(animToPlay, true);
					char.holdTimer = 0;
					char.animation.curAnim.curFrame = char.animation.curAnim.frames.length - 1;
				}
				else if (char.animation.curAnim.curFrame == char.animation.curAnim.frames.length-3)
				{
					char.playAnim(animToPlay, true);
					char.holdTimer = 0;
					char.animation.curAnim.curFrame = char.animation.curAnim.frames.length - 2;
				}
							else
							{
								char.playAnim(animToPlay, true);
			...
			if(!note.noAnimation) {
				...
				//}else{
					if(note.gfNote) {
						...
						{
							if(boyfriend.animation.curAnim.curFrame ==  boyfriend.animation.curAnim.frames.length - 1)
							{
								boyfriend.playAnim(animToPlay + daAlt, true);
								boyfriend.holdTimer = 0;
								boyfriend.animation.curAnim.curFrame = boyfriend.animation.curAnim.frames.length;
							}
							else if(boyfriend.animation.curAnim.curFrame ==  boyfriend.animation.curAnim.frames.length)
							{
								boyfriend.playAnim(animToPlay + daAlt, true);
								boyfriend.holdTimer = 0;
								boyfriend.animation.curAnim.curFrame = boyfriend.animation.curAnim.frames.length - 3;
							}
							else if(boyfriend.animation.curAnim.curFrame ==  boyfriend.animation.curAnim.frames.length-3)
							{
								boyfriend.playAnim(animToPlay + daAlt, true);
								boyfriend.holdTimer = 0;
								boyfriend.animation.curAnim.curFrame = boyfriend.animation.curAnim.frames.length - 2;
							}
						else if (boyfriend.animation.curAnim.curFrame == boyfriend.animation.curAnim.frames.length-2)
						{
							boyfriend.playAnim(animToPlay + daAlt, true);
							boyfriend.holdTimer = 0;
